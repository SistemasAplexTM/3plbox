        ...
        <div class="card">
                    ...
                    <div class="col-md-10 col-md-offset-1">
                        <div class="input-group">
                            ...
                            <div class="form-line" :class="{'error focused': errors.has('descripcion') }">
                                <input name="descripcion" v-model="descripcion" v-validate.disable="'required'"
                                    type="text" class="form-control" placeholder="Descripción">
                            </div>
                            <label v-show="errors.has('descripcion')"
                                class="error">@{{ errors.first('descripcion') }}</label>
                        </div>
                    </div>
                </div>
                <div class="row">
            ...
            <div class="row">
                <div class="col-md-10 col-md-offset-1 text-center">
                    <button type="button" class="btn btn-sm bg-teal waves-effect" @click.prevent="store"
                        v-if="editing==false">
                        <i class="material-icons">save</i>
                        <span>GUARDAR</span>
                    </button>
                    <button type="button" class="btn btn-sm btn-primary waves-effect" @click.prevent="update"
                        v-if="editing==true">
                        <i class="material-icons">edit</i>
                        <span>EDITAR</span>
                    </button>
                    <button type="button" class="btn btn-sm btn-default waves-effect" @click.prevent="cancel"
                        v-if="editing==true">
