            ...
            <div class="body">
                <div class="row">
                    <div class="col-md-10 col-md-offset-1 text-center">
                        <div class="image">
                            <img class="img-circle" src="{{ asset('img/logo_impocargo_mundo.png') }}" width="70"
    height="70" alt="User" />
</div>
</div>
</div>
    ...
    <div class="col-md-10 col-md-offset-1">
        <div class="input-group">
            ...
            <div class="form-line" :class="{'error focused': errors.has('name') }">
                <input name="name" v-model="name" v-validate.disable="'required'" type="text" class="form-control"
    ...
    <div class="col-md-10 col-md-offset-1">
        <div class="input-group">
            ...
            <div class="form-line" :class="{'error focused': errors.has('email') }">
                <input name="email" v-model="email" v-validate.disable="'required|email'" class="form-control"
    ...
    <div class="col-md-10 col-md-offset-1">
        <div class="input-group">
            ...
            <div class="form-line" :class="{'error focused': errors.has('password') }">
                <input name="password" v-model="password" v-validate.disable="[editing ? '': 'required|min:6']"
    ...
    <div class="col-md-10 col-md-offset-1">
        <div class="input-group">
            ...
            <div class="form-line" :class="{'error focused': errors.has('password_confirm') }">
                <input name="password_confirm" v-model="password_confirm" type="password" class="form-control"
